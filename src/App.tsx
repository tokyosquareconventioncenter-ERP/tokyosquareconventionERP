...
import { MasterLockModal } from './components/common/MasterLockModal';
  ...
  return (
    ...
    >
      ...
      <div className="print:hidden">
        ...
        />
        <MasterLockModal onOpenMasterControl={() => setCurrentView('SETTINGS')} />
      </div>
    </AppLayout>
  );
};
...
const AppContent: React.FC = () => {
    ...
    return (
      ...
      >
        ...
        <span className="text-sm font-semibold tracking-wider text-slate-400">
          Construction Accounts & Project ERP
        </span>
      </div>
    );
  }
  ...
  return (
    <DataProvider>
      {currentUser ? <AuthenticatedERPApp /> : <LoginPage />}
    </DataProvider>
  );
};
