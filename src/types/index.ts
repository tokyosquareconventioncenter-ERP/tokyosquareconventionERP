...
export interface SaaSClientItem {
  id: string;
  clientName: string;
  clientPhone: string;
  clientEmail?: string;
...
export interface SaaSClientLicense {
  status: 'ACTIVE' | 'SUSPENDED';
  isLocked: boolean;
  clientName: string;
  clientPhone: string;
  monthlyFee: number; // e.g. 300
  nextBillingDate: string; // YYYY-MM-DD
  lastPaidDate?: string;
  masterPin: string; // Master security PIN to unlock/manage
  suspensionNoticeBn?: string;
  suspensionNoticeEn?: string;
  developerContact: string; // e.g. "01841360000"
  developerEmail: string; // e.g. "Engtotul176@gmail.com"
  developerBkash: string; // e.g. "01841360000"
}
